...
<head>
    ...
    <title>Certificates Import data</title>
...
<div class="wrapper">
    ...
    <div id="content">
        <div class="text-center">
            <h2 class="mb-5">Import data for Certifications</h2>
            ...
            if(isset($_POST['submit'])){
                ...
                if(!$conn)
                    ...
                    if($name== "" || $event == "" || $date== "" || $duration == "" || $cert_id == "")
                        ...
                        $result = mysqli_query($conn,"INSERT INTO details(certid,Name,Event,Duration,Date) VALUES ('$cert_id','$name','$event','$duration','$date')");
                        if($result){
                            ?>
